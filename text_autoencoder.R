...
output_shape <- c(batch_size, 1L, 20L, filters)
...
# saveRDS(X, "Nietzsche_X.rds")
X <- readRDS("Nietzsche_X.rds")
# num_sentences <- length(X)
# train_test_split <- 0.9
# train_size <- round(num_sentences*train_test_split)
# test_size <- round(num_sentences*(1 - train_test_split))
# train_ind <- sample(1:num_sentences, size = train_size )
# 
# x_train <- sample(X, n)
# 
# x_test <- data$test
